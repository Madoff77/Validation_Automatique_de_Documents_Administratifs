...
export default function DocumentDetail() {
    ...
    if (!doc)
        return <div className="p-8 text-gray-500">Document introuvable.</div>;
                        ...
                        <Card className="gap-0 py-0 shadow-none">
                            ...
                            <CardContent className="px-6 py-4 border-t">
                                ...
                                <FieldRow
                                    icon={Euro}
                                    label="Montant HT"
                                    value={formatAmount(ext.montant_ht)}
                                />
                                <FieldRow
                                    icon={Euro}
                                    label="Montant TVA"
                                    value={formatAmount(ext.montant_tva)}
                                />
                                <FieldRow
                                    icon={Euro}
                                    label="Montant TTC"
                                    value={formatAmount(ext.montant_ttc)}
                                    highlight={!!ext.montant_ttc}
                                />
                                <FieldRow
                                    icon={null}
                                    label="Taux TVA"
                                ...
                                <FieldRow
                                    ...
                                    value={ext.date_expiration}
                                    highlight={!!ext.date_expiration}
                                />
                                <FieldRow
                                    icon={null}
                                    label="N° document"
                                    value={ext.numero_document}
                                />
                                <FieldRow
                                    icon={CreditCard}
                                    label="IBAN"
                        ...
                        <CardContent className="px-6 py-4 border-t space-y-3 text-sm">
                            ...
                            {doc.ocr_quality_score && (
                                <div>
                                    ...
                                    <span className="text-gray-700">
                                        {(doc.ocr_quality_score * 100).toFixed(
                                            0,
                                        )}
                                        %
                                    </span>
